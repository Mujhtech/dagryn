...
import (
	...
	pkgdatabase "github.com/mujhtech/dagryn/pkg/database"
)

// NewCmd creates the migrate command.
...
func getDatabaseURL(override string) string {
	...
	return pkgdatabase.DefaultConfig().URL
}
...
func runMigrateUp(databaseURL string) error {
	...
	database, err := pkgdatabase.New(ctx, cfg)
	if err != nil {

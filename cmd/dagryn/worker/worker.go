...
// NewCmd creates the worker command.
...
func runWorker(opts workerConfigOpts) error {
	...
	jobCfg := worker.Config{
		...
		EnvSecretsProvider:            cfg.EnvSecrets.Provider,
		EnvSecretsProviderRefPrefix:   cfg.EnvSecrets.ProviderRefPrefix,
		EnvSecretsCloudflareStoreID:   cfg.EnvSecrets.CloudflareStoreID,
		EnvSecretsAWSRegion:           cfg.EnvSecrets.AWSRegion,
		EnvSecretsAWSAccessKeyID:      cfg.EnvSecrets.AWSAccessKeyID,
		EnvSecretsAWSSecretAccessKey:  cfg.EnvSecrets.AWSSecretAccessKey,
		EnvSecretsAWSCredentialsFile:  cfg.EnvSecrets.AWSCredentialsFile,
		EnvSecretsGCPCredentialsFile:  cfg.EnvSecrets.GCPCredentialsFile,
		EnvSecretsCloudflareAccountID: cfg.EnvSecrets.CloudflareAccountID,
		EnvSecretsCloudflareAPIToken:  cfg.EnvSecrets.CloudflareAPIToken,
		EnvSecretsCloudflareAPIBase:   cfg.EnvSecrets.CloudflareAPIBase,
	}
